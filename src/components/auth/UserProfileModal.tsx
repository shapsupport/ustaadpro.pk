...
import { X, Mail, Phone, LogOut, CheckCircle2, Wallet, CalendarDays, MessageCircle, ChevronRight, AlertTriangle, ArrowLeft, Camera, Loader2, Trash2 } from "lucide-react";
            ...
            {confirmDelete ? (
              <div className="rounded-2xl border border-red-200 bg-red-50/80 p-4 space-y-3">
                ...
                <p className="text-xs text-red-600 leading-relaxed">
                  This will permanently delete your account, bookings, receipts, wallet balance, and complaints. This action cannot be undone.
                </p>
                {message && (
                  <p className="text-xs font-semibold text-red-700 bg-white p-2 rounded-xl border border-red-200">
                    {message.text}
                  </p>
                )}
                <div className="flex items-center gap-2 pt-1">
                  <button
                    ...
                    className="flex-1 rounded-xl border border-slate-300 bg-white py-2 text-xs font-bold text-slate-700 hover:bg-slate-50 transition"
                  >
                    Cancel
                  </button>
                  <button
                    ...
                    className="flex-1 flex items-center justify-center gap-1.5 rounded-xl bg-red-600 py-2 text-xs font-bold text-white hover:bg-red-700 transition disabled:opacity-50"
                  >
              ...
              <>
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 text-red-500 hover:text-red-700 font-semibold py-2 rounded-2xl text-xs transition-all"
                >
